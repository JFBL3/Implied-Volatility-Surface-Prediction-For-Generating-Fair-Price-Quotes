...
# Set up logging
logging.basicConfig(filename='market_collection.log', level=logging.INFO,
...
def append_to_csv(df, filename='market_collection.csv'):
    """
...
def job():
    try:
        ...
        if options_data_set is not None and not options_data_set.empty:
            ...
            logging.info(f"Data collected and appended to market_collection.csv")
        else:
